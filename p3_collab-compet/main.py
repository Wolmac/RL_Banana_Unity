...
env = UnityEnvironment(file_name='./Tennis_Linux/Tennis.x86_64')# get the default brain
...
agent_list.append(ddpg_agent.Agent(state_size=24, action_size=2, random_seed=100))
for a in range(1):
